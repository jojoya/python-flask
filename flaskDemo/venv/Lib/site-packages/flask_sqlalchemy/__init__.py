...
class _SQLAlchemyState(object):
    """Remembers configuration for the (db, myapp) tuple."""
...
class SQLAlchemy(object):
    ...
    from the :mod:`sqlalchemy` and :mod:`sqlalchemy.orm` models.  So you can
    ...
    def create_scoped_session(self, options=None):
        ...
        specify a custom scope function.  If it's not provided, Flask's myapp
    ...
    def get_binds(self, app=None):
        ...
        This is suitable for use of sessionmaker(binds=db.get_binds(myapp)).
        """
        app = self.get_app(app)
