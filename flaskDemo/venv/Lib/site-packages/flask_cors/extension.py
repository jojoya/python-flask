...
class CORS(object):
    ...
    :param resources:
        ...
        expressions, for which the myapp-wide configured options are applied.

        If the argument is a string, it is expected to be a regular expression
        for which the myapp-wide configured options are applied.

        Default : Match all and apply myapp-level configuration
    ...
    def init_app(self, app, **kwargs):
        ...
        # the myapp's configuration, the constructor, the kwargs to init_app, and
