...
Options:
    ...
    --diff <file>         Compare models in requirements.txt to project imports.
    --clean <file>        Clean up requirements.txt by removing models that are not imported in project.
"""
...
def parse_requirements(file_):
    ...
    module:version, and add dict to list of parsed models.
    ...
    for x in data:
        if not any([y in x for y in delim]):  # Check for models w/o a specifier.
...
def compare_modules(file_, imports):
    """Compare models in a file to imported models in a project.

    Args:
        file_ (str): File to parse for models to be compared.
        imports (tuple): Modules being imported in the project.

    Returns:
        tuple: The models not imported in the project, but do exist in the
               specified file.
    """
...
def diff(file_, imports):
    """Display the difference between models in a file and imported models."""
    modules_not_imported = compare_modules(file_, imports)

    logging.info("The following models are in {} but do not seem to be imported: "
                 "{}".format(file_, ", ".join(x for x in modules_not_imported)))

def clean(file_, imports):
    """Remove models that aren't imported in project from file."""
    modules_not_imported = compare_modules(file_, imports)
