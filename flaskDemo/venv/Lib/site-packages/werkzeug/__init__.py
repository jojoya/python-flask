...
# they are all importable from "werkzeug" instead of the models where they are
...
# module will then lazily import from the models that implement the objects.


# import mapping to objects in other models
all_by_module = {
...
# models that should be imported when accessed as attributes of werkzeug
...
class module(ModuleType):
    ...
    """Automatically import objects from the models."""
...
# setup the new module and patch it into the dict of loaded models
